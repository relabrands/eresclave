...
import { LayoutDashboard, HandCoins, LogOut, Menu, X, ExternalLink, Users, Target, HeartHandshake, Flame } from "lucide-react";
...
const nav = [
  ...
  { to: "/dashboard/impacto", label: "Impacto Real", Icon: Flame },
];

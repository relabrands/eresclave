  ...
  return (
    <div className="min-h-screen flex flex-col bg-background" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <main className="flex-1 pb-20 md:pb-0">
        {/* Hero */}
        <section className="bg-hero-gradient py-12 sm:py-24 relative overflow-hidden">
          <div
          ...
          <div className="container-tight relative text-center max-w-2xl mx-auto">
            <span className="inline-block bg-accent text-white text-[11px] sm:text-xs font-semibold px-3.5 py-1 sm:px-4 sm:py-1.5 rounded-full mb-4 sm:mb-6 tracking-wide">
            ...
            <p className="mt-3 sm:mt-5 text-white/75 text-sm sm:text-lg leading-relaxed max-w-lg mx-auto">

...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Eres Clave · Iniciativa juvenil de Las Charcas" },
      { name: "description", content: "Iniciativa de Robinson Sánchez para impulsar a la juventud de Las Charcas con útiles, becas y acompañamiento." },
      { name: "author", content: "Robinson Sánchez" },
